    ...
    <div class="flex flex-col bg-white h-14" style="-webkit-app-region: drag">
        <div class="h-6 flex justify-end">
            ...
            <el-icon style="-webkit-app-region: no-drag" size="16"
                class="mx-2 pt-1 hover:bg-gray-200 focus:outline-none cursor-pointer" @click="minWindow">
            ...
            <!-- 最大化 -->
            <el-icon style="-webkit-app-region: no-drag" v-if="isMax" size="16"
            ...
            <!-- 关闭 -->
            <el-icon style="-webkit-app-region: no-drag" size="16"
                class="mx-2 pt-1 hover:bg-red-400 focus:outline-none cursor-pointer" @click="closeWindow">
